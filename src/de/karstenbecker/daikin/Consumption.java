...
public class Consumption {
  ...
  public static Consumption doSetup(Node node, String baseName, String json) {
   Consumption consumption = new Consumption(node, baseName);
   consumption.updateValues(json, true);
  return consumption;
  } 
  
  public static void main(String[] args) {
    Consumption.doSetup(null, "energy", "{\"Electrical\":{\"Heating\":{\"D\":[0,0,0,0,0,0,0,2,0,3,10,0,0,0,0,0,null,null,null,null,null,null,null,null],\"W\":[2,3,2,4,2,2,2,1,3,1,2,3,15,0],\"M\":[90,54,56,54,45,58,51,63,47,44,55,74,81,94,null,null,null,null,null,null,null,null,null,null]}}}");
  }
